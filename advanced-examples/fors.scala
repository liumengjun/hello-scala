/**
  * for comprehensions (see also Sequence Comprehensions)
  * http://www.scala-lang.org/old/node/47.html
  */
...
object Persons {
  ...
  def olderThan20(xs: Seq[Person]): Iterator[String] =
    olderThan20i(xs.toIterator)

  /** Return an iterator over persons older than 20, given
    * an iterator over persons.
    */
  def olderThan20i(xs: Iterator[Person]): Iterator[String] = {
